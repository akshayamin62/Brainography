    ...
    <div className="min-h-screen bg-white px-4 py-12 text-gray-800 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm sm:p-10">
          <h1 className="mb-2 text-4xl font-bold tracking-tight text-gray-900">Refund Policy</h1>
          <p className="text-lg font-medium text-gray-700">ADMITra</p>
          <p className="mb-10 text-base text-gray-500">Effective Date: 15.04.2026</p>

          <div className="prose prose-lg prose-gray max-w-none space-y-8 leading-8 text-gray-700 prose-headings:scroll-mt-24 prose-headings:font-semibold prose-headings:text-gray-900 prose-h2:text-2xl prose-p:text-[17px] prose-li:text-[17px] prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline">
            <section>
              <p>
                This Refund Policy applies to all services, products, programs, assessments,
                consulting engagements, platform access, and business opportunities offered by
                KAREER Studio and ADMITra (collectively referred to as “Company”, “we”, “us”, “our”).
              </p>
              <p>
                By making any payment to the Company, the user (“Client”) agrees to this Refund Policy.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                No refund shall be provided once payment is made, irrespective of usage,
                non-usage, or partial usage of services.
              </p>
            </section>

            <section>
              <h2>2. NO REFUND ON CHANGE OF INTENT</h2>
            ...
            <section>
              <h2>3. NO REFUND BASED ON OUTCOMES</h2>
            ...
            <section>
              <h2>4. NO REFUND FOR DELAYS OR THIRD-PARTY FACTORS</h2>
            ...
            <section>
              <h2>7. FRAUD OR MISREPRESENTATION</h2>
            ...
            <section>
              <h2>10. MODIFICATION OF POLICY</h2>
            ...
            <section>
              <h2>12. CONTACT</h2>
              <p>
                Entity: ADMITra and it’s associates
                <br />
                Email: <a href="mailto:hello@admitra.io">hello@admitra.io</a>
                <br />
                Website: <a href="https://core.admitra.io" target="_blank" rel="noopener noreferrer">https://core.admitra.io</a>
              </p>
            </section>
          </div>
        </div>
