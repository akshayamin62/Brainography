...
export default function ScannerDownloadPage() {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex flex-col items-center px-4 py-10">
      ...
      {/* BUG-046: Loading state while checking file availability */}
      {checking && (
        <div className="w-full max-w-lg mb-6 bg-blue-50 border border-blue-200 rounded-xl px-5 py-4 flex items-center gap-3">
          <svg className="w-5 h-5 text-blue-600 shrink-0 animate-spin" fill="none" viewBox="0 0 24 24">
            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
          </svg>
          <p className="text-sm text-blue-800">Checking download availability...</p>
        </div>
      )}
